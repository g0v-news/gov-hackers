...
export const license = {
  ...
  image: [
    ...
    { name: '《各國開外掛》標頭', license: '城市實驗室受訪者授權使用', link: null },
    { name: 'Code for Japan', license: '受訪者授權使用', link: null },
    { name: 'Code for Australia', license: '受訪者授權使用', link: null },
    { name: 'Code for Pakistan', license: '受訪者授權使用', link: null },
    { name: '城市實驗室', license: '受訪者授權使用', link: null },
  ...
  partner: [{ name: '台灣公務革新力量聯盟', link: 'https://www.facebook.com/thinking4public/' }],
  publisher: [
