...
export const history = {
  ...
  event: [
    ...
    { date: '2015/06', name: '八仙塵暴', content: '點燃台北市與網路社群協作的第一案，24小時內開發傷患搜尋網站' },
...
export const license = {
  ...
  image: [
    { name: 'peggy', license: 'CC BY 2.0 othree', link: '' },
    { name: '小彭', license: 'CC BY 4.0 Saul Peng', link: '' },
    { name: 'kiang', license: '受訪者授權使用', link: '' },
    { name: 'TonyQ', license: 'CC BY 2.0 othree', link: '' },
    ...
    { name: '台北市政府內部', license: 'CC BY 2.0 chihao', link: '' },
    { name: '行政院內部', license: 'CC BY 2.0 chihao', link: '' },
    { name: '唐鳳', license: 'CC BY SA 2.0 Medialab Prado', link: '' },
    { name: 'clkao', license: 'CC BY SA 2.0 COSCUP', link: '' },
    { name: 'yutin', license: 'CC BY 2.0 othree', link: '' },
  ],
  interview: [{ name: '台灣公務革新力量聯盟', link: '' }],
  publication: [
    { name: '商業週刊', link: '' },
    { name: '報導者', link: '' },
  ],
